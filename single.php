...
if(sm_NullEmpty($toCheck )){$toCheck='select-default';}
...
<div id="content" class="site-content">
	...
	if(($pS=='select-page' || $pS == '' || $genPS=='pageLike' && $pS=='select-default') || is_attachment() || sm_NullEmpty($tst)){
				echo'<style scoped> 
						.bc-image-post {
							height: 200px;
						}
	...
	$tst = get_post_meta(get_the_ID(), 'bck_image', true); 
		...
		if((($oLay=='select-yes' && $pS=='select-post' || $oLay=='select-default' && $genOLay == 'yes' && $pS=='select-post' || $oLay=='select-default' && $genOLay == 'yes' && $genPS=='postLike' && $pS=='select-default') && !sm_NullEmpty($tst)) && !is_attachment()){
			echo'<div class="post-overlay">
			<div class="post-overlay-top"></div>
			<div class="post-overlay-bottom"></div>
		</div>';
		}else if($oLay=='select-yes' && $pS=='select-page' || $oLay=='select-default' && $genOLay == 'yes' && $pS =='select-page' || $oLay =='select-default' && $genOLay == 'yes' && $genPS =='pageLike' && $pS=='select-default' ||  sm_NullEmpty($tst) || is_attachment() ){
		...
		<div id="primary" class="content-area">
			<div id="main" class="site-main article-image-content article-classic" role="main">
				<header class="entry-header-classic">
					...
					$tst = get_post_meta(get_the_ID(), 'bck_image', true);
					echo getImageReturn($tst,1280,500);
