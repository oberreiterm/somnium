...
if( ! function_exists( 'codestar_wp_color_picker' ) ) {
  function codestar_wp_color_picker() {
    ...
    wp_enqueue_style( 'cs-wp-color-picker',get_template_directory_uri().'/color_picker/css/cs-wp-color-picker.min.css', array( 'wp-color-picker' ), '1.0.0', 'all' );

    // enqueue scripts
    wp_enqueue_script( 'wp-color-picker' );
    wp_enqueue_script( 'cs-wp-color-picker', get_template_directory_uri().'/color_picker/js/cs-wp-color-picker.js', array( 'wp-color-picker' ), '1.0.0', true );
